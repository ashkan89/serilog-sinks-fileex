...
Log.Logger = new LoggerConfiguration()
    .WriteTo
    .FileEx("logs/IranCardExternalAPI.log", "-yyyy-MM-dd-HHmm", LogEventLevel.Debug, rollingInterval: RollingInterval.Minute, rollOnEachProcessRun: false,
        fileSizeLimitBytes: (100L * 1024), rollOnFileSizeLimit: true, retainedFileCountLimit: 5, preserveLogFilename: true,

...
public static class FileLoggerConfigurationExtensions
{
    ...
    /// overload of <see cref="FileEx(LoggerSinkConfiguration, string, LogEventLevel, string, IFormatProvider, long?, LoggingLevelSwitch, bool, bool, TimeSpan?)"/>
    ...
    public static LoggerConfiguration FileEx(
        ...
        Encoding encoding)
    {
        return FileEx(sinkConfiguration, path, restrictedToMinimumLevel, outputTemplate, formatProvider, fileSizeLimitBytes, levelSwitch, buffered,
    ...
    public static LoggerConfiguration FileEx(
        ...
        Encoding encoding)
    {
        return FileEx(sinkConfiguration, formatter, path, restrictedToMinimumLevel, fileSizeLimitBytes, levelSwitch, buffered,
            shared, flushToDiskInterval, rollingInterval, rollOnFileSizeLimit, retainedFileCountLimit, encoding, null);
    }
        ...
        TimeSpan? retainedFileTimeLimit = null)
    {
        ...
        return FileEx(sinkConfiguration, formatter, path, restrictedToMinimumLevel, fileSizeLimitBytes,
    ...
    public static LoggerConfiguration FileEx(
        ...
        LoggingLevelSwitch levelSwitch)
    {
        return FileEx(sinkConfiguration, formatter, path, restrictedToMinimumLevel, levelSwitch, null, null);
    }
        ...
        FileLifecycleHooks? hooks = null)
    {
        ...
        var formatter = new MessageTemplateTextFormatter(outputTemplate, formatProvider);
        return FileEx(sinkConfiguration, formatter, path, restrictedToMinimumLevel, levelSwitch, encoding, hooks);
    }
    ...
    /// <param name="formatter">A formatter, such as <see cref="JsonFormatter"/>, to convert the log events into
    /// text for the file. If control of regular text formatting is required, use the other
    /// overload of <see cref="FileEx(LoggerAuditSinkConfiguration, string, LogEventLevel, string, IFormatProvider, LoggingLevelSwitch, Encoding, FileLifecycleHooks)"/>
    /// and specify the outputTemplate parameter instead.
    /// </param>
    /// <param name="path">Path to the file.</param>
    /// <param name="restrictedToMinimumLevel">The minimum level for
